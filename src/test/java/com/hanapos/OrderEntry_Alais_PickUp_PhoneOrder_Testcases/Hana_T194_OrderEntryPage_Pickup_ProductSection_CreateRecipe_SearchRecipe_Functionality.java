...
public class Hana_T194_OrderEntryPage_Pickup_ProductSection_CreateRecipe_SearchRecipe_Functionality extends TestBaseClass {
	...
	public void Validate_Hana_T194_OrderEntryPage_Pickup_ProductSection_CreateRecipe_SearchRecipe_Functionality_Test() {
		SoftAssert softassert = new SoftAssert();
		logger.info("**** Starting  Hana_T194_OrderEntryPage_Pickup_ProductSection_CreateRecipe_SearchRecipe_Functionality ****");
		...
		try {
			...
			// Test Step - 14
			phoneorder.Search_Recipe_SearchBox("Test QA");
			delayWithGivenTime(2000);
			...
			// Test Step - 15
			phoneorder.Click_SearchAndSelectRecipeName();
			softassert.assertEquals(phoneorder.get_recipename_OnRecipenameTextbox(),"Test QA","Test Step - 15 - Entered Recipe name from autosuggestion is not displayed");
			
			// Test Step - 16
			delayWithGivenTime(2000);
			softassert.assertEquals(phoneorder.Verify_RecipeItemRow1_OnTableIsDisplayed(), "Delphinium Pink - Hot","Test Step -  16 - Recipe Row1 item is not loaded after searched the recipe");
			softassert.assertEquals(phoneorder.Verify_RecipeItemRow2_OnTableIsDisplayed(), "Chrysanthemum Spray/Pompon - Cushion Red","Test Step -  16 - Recipe Row2 item is not loaded after searched the recipe");
