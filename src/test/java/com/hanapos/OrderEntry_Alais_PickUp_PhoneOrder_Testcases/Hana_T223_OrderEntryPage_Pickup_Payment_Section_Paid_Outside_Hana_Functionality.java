...
public class Hana_T223_OrderEntryPage_Pickup_Payment_Section_Paid_Outside_Hana_Functionality extends TestBaseClass {
	...
	public void Validate_Hana_T223_OrderEntryPage_Pickup_Payment_Section_Paid_Outside_Hana_Functionality_Test(
		...
		logger.info("**** Starting  Validate_Hana_T223_OrderEntryPage_Pickup_Payment_Section_Paid_Outside_Hana_Functionality_Test  ****");
		...
		try {
			...
			// Test Step - 10			
			phoneorder.SelectPaymentTypeOnPhoneOrderPage_PaymentSection("Paid Outside Hana");
			delayWithGivenTime(1000);
			softassert.assertEquals(phoneorder.get_SelectedPaymentType_OnPhoneOrderPage(),"Paid Outside Hana", "Test Step - 10 - Selected payment type is not displayed");
			...
			// Test Step - 13
			softassert.assertEquals(orderconfirmationpage.get_PaymentType(), "Paid Outside Hana", "Test Step - 13 - Payment type is not displayed on order confirmation page");
			...
			// Test Step - 15
			dashboardorder.EnterGlobalSearch(dashboardorder.get_InvoiceNumber_PhoneOrder_PickUp_Paid_Outside_Hana_PaymentType());
			delayWithGivenTime(1000);
			softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Paid_Outside_Hana_PaymentType_PickUp_InvoiceNumber(),"Test Step - 15 - In orders summary page cash payment type invoice number is not displayed for placed order");		
		
			//Test Step - 16
			delayWithGivenTime(1000);
			softassert.assertEquals(dashboardorder.Validate_PhoneOrder_Paid_Outside_Hana_PaymentType_PickUp_ModeOfPayment(),"Paid Outside Hana","Test Step - 16 - Mode of payment as Paid Outside Hana type is not displayed");
