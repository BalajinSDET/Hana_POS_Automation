...
public class Hana_T149_Pickup_RecipientSection_ClearTime_FT extends TestBaseClass {
	...
	public void Validate_Hana_T149_Pickup_RecipientSection_ClearTime_Functionality_Test() {
		SoftAssert softassert = new SoftAssert();
		logger.info("**** Starting  Hana_T149_Pickup_RecipientSection_ClearTime_Functionality_Test ****");
		...
		try {
			...
			softassert.assertEquals(phoneorder.getDeliveryDateOnReciSection(),NextDate(),"Test Step - 9 - Delivery date is not displayed with expected delivery date on phone order page recipient section");
			
			// Test Step - 10
			phoneorder.Select_DeliveryOnTime_Dropdown("Exactly At");
			softassert.assertEquals(phoneorder.getSelected_DeliveryOnTimeOptions_OnDropdown_RecipientSection(),"Exactly At","Test Step - 10 - Delivery time on dropdown selected option is not displayed with expected delivery time on phone order page recipient section");
