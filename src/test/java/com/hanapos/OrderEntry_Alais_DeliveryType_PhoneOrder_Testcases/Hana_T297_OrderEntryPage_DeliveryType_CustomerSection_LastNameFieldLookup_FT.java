...
public class Hana_T297_OrderEntryPage_DeliveryType_CustomerSection_LastNameFieldLookup_FT extends TestBaseClass {
	private LoginPage lp;
	private HanaDashBoardPage dashboard;
	private OrderEntry_Alais_PhoneOrderPage phoneorder;
	
	public static final String dataSheetName = "Hana_T92";
	...
	public void Validate_Hana_T297_OrderEntryPage_DeliveryType_CustomerSection_LastNameFieldLookup_Functionality_Test(String salesperson, String custlname, String searchandselectlname) {
		// SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
		CustomSoftAssert softassert = new CustomSoftAssert();
		
		logger.info("**** Starting  Validate_Hana_T297_OrderEntryPage_DeliveryType_CustomerSection_LastNameFieldLookup_Functionality_Test  ****");
		...
		try {
			...
			softassert.assertFalse(phoneorder.Verify_CustLastNameSection_AutosuggestionAppears(), "Test Step - 7 - Customer section last name autosuggestion is not displayed on phone order page");
			
			// Test Step - 8
			phoneorder.SearchAndSelect_LastnameOnCustSection(prop.getProperty("cust_lastName"),searchandselectlname);
			delayWithGivenTime(2000);
