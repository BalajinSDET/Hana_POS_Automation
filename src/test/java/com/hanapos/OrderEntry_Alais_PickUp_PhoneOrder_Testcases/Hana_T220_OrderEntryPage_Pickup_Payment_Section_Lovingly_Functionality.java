...
public class Hana_T220_OrderEntryPage_Pickup_Payment_Section_Lovingly_Functionality extends TestBaseClass {
	...
	public void Validate_Hana_T220_OrderEntryPage_Pickup_Payment_Section_Lovingly_Functionality_Test(
		...
		logger.info("**** Starting  Validate_Hana_T220_OrderEntryPage_Pickup_Payment_Section_Lovingly_Functionality_Test  ****");
		...
		try {
			...
			// Test Step - 10			
			phoneorder.SelectPaymentTypeOnPhoneOrderPage_PaymentSection("Lovingly");
			delayWithGivenTime(1000);
			...
			// Test Step - 13
			softassert.assertEquals(orderconfirmationpage.get_PaymentType(), "Lovingly", "Test Step - 13 - Payment type is not displayed on order confirmation page");
			...
			// Test Step - 15
			dashboardorder.EnterGlobalSearch(dashboardorder.get_InvoiceNumber_PhoneOrder_PickUp_Lovingly_PaymentType());
			delayWithGivenTime(1000);
			softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Lovingly_PaymentType_PickUp_InvoiceNumber(),"Test Step - 15 - In orders summary page cash payment type invoice number is not displayed for placed order");		
		
			//Test Step - 16
			delayWithGivenTime(1000);
			softassert.assertEquals(dashboardorder.Validate_PhoneOrder_Lovingly_PaymentType_PickUp_ModeOfPayment(),"Lovingly","Test Step - 16 - Mode of payment as Lovingly type is not displayed");
