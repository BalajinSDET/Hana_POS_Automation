...
public class Hana_T202_OrderEntryPage_Pickup_ProductSection_CreateRecipe_LabourCostClear_Functionality extends TestBaseClass {
	...
	public void Validate_Hana_T202_OrderEntryPage_Pickup_ProductSection_CreateRecipe_LabourCostClear_Functionality_Test() {
		// SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
		CustomSoftAssert softassert = new CustomSoftAssert();
		
		logger.info("**** Starting  Validate_Hana_T202_OrderEntryPage_Pickup_ProductSection_CreateRecipe_LabourCostClear_Functionality_Test ****");
		...
		try {
			...
			// Test Step - 18
			delayWithGivenTime(1000);
			softassert.assertTrue(phoneorder.Verify_labourcost_label(),"Test Step - 18 - Labour cost label is not displayed on create recipe popup");
			softassert.assertTrue(phoneorder.Verify_labourcost_amount(),"Test Step - 18 - Labour cost amount is not displayed on create recipe popup");

			// Test Step - 19
			softassert.assertTrue(phoneorder.Verify_Clearhyperlink_OnCreateRecipePopup_IsDisplayed(),"Test Step - 18 - Clear hyperlink is not displayed on labour cost in create recipe popup");

			// Test Step - 20
			softassert.assertEquals(phoneorder.Verify_Clearhyperlink_Tooltip_OnCreateRecipePopup(), "Don't want to charge labor cost on this item? Use Clear button to remove labor costs for this recipe.","Test Step - 20 - Clear hyperlink tooltip is not displayed on create recipe popup");
			
			// Test Step - 21
			delayWithGivenTime(1000);
			phoneorder.Click_Clearhyperlink_OnCreateRecipePopup();
			softassert.assertEquals(phoneorder.get_labourcost_amount(), "$0.00","Test Step - 21 - Labour cost amount is not cleared & value $0.00 is not updated on create recipe popup");
