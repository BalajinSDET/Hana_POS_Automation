...
public class Hana_T132_Pickup_CustomerSection_Edit_Customer_CustomerDetails_OrderDetails_NameSearchFilter_FT extends TestBaseClass {
	...
	public void Validate_Hana_T132_Pickup_CustomerSection_Edit_Customer_CustomerDetails_OrderDetails_NameSearchFilter_Functionality_Test() {
		...
		try {
			...
			// Test Step - 9
			ThreadWait(1000);
			phoneorder.Enter_Name_OrderDetailsTab_CustomerDetailsPopup("Abish");
		
			 // Test Step - 10
			RobotPressEnter();
			ThreadWait(1500);
			softassert.assertTrue(phoneorder.Verify_Name_Orderdetailstab("Abish"),"Test Step - 10 - Filtered Name is not displayed on the order details tab at customer details popup");
			...
			RobotPressEnter();
			ThreadWait(2000);
			softassert.assertTrue(phoneorder.Verify_Name_Orderdetailstab("Abish David"),"Test Step - 12 - Filtered name with 3 characters is not displayed on the order details tab at customer details popup");
			
			// Test Step - 13
			ThreadWait(1000);
			phoneorder.Enter_Name_OrderDetailsTab_CustomerDetailsPopup("Liam Jack");
			ThreadWait(1000);
			RobotPressEnter();
