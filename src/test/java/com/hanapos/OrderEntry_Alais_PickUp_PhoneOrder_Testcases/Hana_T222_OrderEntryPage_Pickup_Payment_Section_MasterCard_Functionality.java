...
public class Hana_T222_OrderEntryPage_Pickup_Payment_Section_MasterCard_Functionality extends TestBaseClass {
	...
	public void Validate_Hana_T222_OrderEntryPage_Pickup_Payment_Section_MasterCard_Functionality_Test(
		...
		logger.info("**** Starting  Validate_Hana_T222_OrderEntryPage_Pickup_Payment_Section_MasterCard_Functionality_Test  ****");
		...
		try {
			...
			// Test Step - 10			
			phoneorder.SelectPaymentTypeOnPhoneOrderPage_PaymentSection("Master Card");
			delayWithGivenTime(1000);
			softassert.assertEquals(phoneorder.get_SelectedPaymentType_OnPhoneOrderPage(),"Master Card", "Test Step - 10 - Selected payment type is not displayed");
			...
			// Test Step - 13
			softassert.assertEquals(orderconfirmationpage.get_PaymentType(), "Master Card", "Test Step - 13 - Payment type is not displayed on order confirmation page");
			...
			// Test Step - 15
			dashboardorder.EnterGlobalSearch(dashboardorder.get_InvoiceNumber_PhoneOrder_PickUp_MasterCard_PaymentType());
			delayWithGivenTime(1000);
			softassert.assertTrue(dashboardorder.Validate_PhoneOrder_MasterCard_PaymentType_PickUp_InvoiceNumber(),"Test Step - 15 - In orders summary page cash payment type invoice number is not displayed for placed order");		
		
			//Test Step - 16
			delayWithGivenTime(1000);
			softassert.assertEquals(dashboardorder.Validate_PhoneOrder_MasterCard_PaymentType_PickUp_ModeOfPayment(),"Master Card","Test Step - 16 - Mode of payment as Master Card type is not displayed");
