package com.hanapos.OrderEntry_Alais_WireOut_PhoneOrderTest;
...
public class Hana_T520_OrderEntryPage_WireOut_Functionality_with_New_customer_FT extends TestBaseClass {
	...
	public void Validate_Hana_T520_OrderEntryPage_WireOut_Functionality_with_New_customer_Functionality_Test(String salesperson, String custaddress1, String custzip,String custphone, String recifname, String recilname, String reciaddress1, String reciaddress2, String recizip,
		...
		try {
			...
			phoneorder.EnterCustomerFirstName("stuart"+twodigitrandomeString());
			...
			delayWithGivenTime(2000);
			softassert.assertEquals(phoneorder.getFirstnameOnPhoneOrderPage().contains("stuart"),true, "Test Step - 6 - First name is not displayed on phone order page");
			...
			delayWithGivenTime(2000);
			softassert.assertEquals(dashboardorder.getCustAndcompyNameOnDeliveryPopup().contains("stuart Jones"),false,"Test Step - 15 - customer and company name on delivery popup is not matched");
			...
			// Test Step - 19
			delayWithGivenTime(2000);
			softassert.assertEquals(customerpage.getCustDetailsFirstNameTextBox().contains("stuart"), true,"Test Step - 19 - Added on first name field are not properly displayed");
