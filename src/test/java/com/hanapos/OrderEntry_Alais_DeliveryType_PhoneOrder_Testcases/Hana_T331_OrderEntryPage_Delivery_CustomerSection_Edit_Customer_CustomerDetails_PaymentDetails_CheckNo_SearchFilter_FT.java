...
public class Hana_T331_OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_CheckNo_SearchFilter_FT extends TestBaseClass {
	...
	public void Validate_Hana_T331_OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_CheckNo_SearchFilter_Functionality_Test(String valid_checkno, String three_digit_checkno, String invalid_checkno) {
		// SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
		CustomSoftAssert softassert = new CustomSoftAssert();
		
		logger.info("**** Starting Hana_T331_OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_CheckNo_SearchFilter_FT  ****");
		...
		try {
			...
			// Test Step - 14			
			softassert.assertTrue(phoneorder.Verify_CheckNoSearchBox_ClearButton_Appears(),"Test Step - 14 - Clear button in Check number search box is not displayed");
			
			// Test Step - 15
			phoneorder.Click_CheckNoSearchBox_ClearButton();
			softassert.assertEquals(phoneorder.get_CheckNoSearchBox_Paymentdetailstab(), "","Test Step - 15 - In Check number searchbox entered data is not cleared");
