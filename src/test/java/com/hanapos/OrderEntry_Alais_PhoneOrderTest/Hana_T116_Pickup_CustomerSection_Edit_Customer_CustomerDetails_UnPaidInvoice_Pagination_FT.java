...
public class Hana_T116_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Pagination_FT extends TestBaseClass {
	...
	public void Validate_Hana_T116_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Pagination_Functionality_Test() {
		SoftAssert softassert = new SoftAssert();
		logger.info("**** Starting Hana_T116_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Pagination_FT  ****");
		...
		try {
			...
			delayWithGivenTime(1000);
			softassert.assertEquals(phoneorder.get_TotalPagenumber_Appears_OnUnpaidTab_OnCustomerDetailsPopup().contains("26 - "+phoneorder.get_TotalPageNumber_Appears_OnUnpaidTab()),true,"Test Step - 13 - Florist does not navigated to the next page no.2 on the unpaid invoice tab under the table");
			...
			delayWithGivenTime(1000);
			softassert.assertEquals(phoneorder.get_TotalPagenumber_Appears_OnUnpaidTab_OnCustomerDetailsPopup().contains("26 - "+phoneorder.get_TotalPageNumber_Appears_OnUnpaidTab()),true,"Test Step - 15 - Florist does not navigated to the last page on the unpaid invoice tab under the table");
			...
			phoneorder.Click_LastPagePaginationIcon_OnUnpaidTab_OnCustomerDetailsPopup();
			delayWithGivenTime(1000);
			softassert.assertEquals(phoneorder.get_TotalPagenumber_Appears_OnUnpaidTab_OnCustomerDetailsPopup().contains("26 - "+phoneorder.get_TotalPageNumber_Appears_OnUnpaidTab()),true,"Test Step - 18 - Florist does not navigated to the last page on the unpaid invoice tab under the table");
