...
public class Hana_T326_OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_ExportToExcel_FT extends TestBaseClass {
	private LoginPage lp;
	private HanaDashBoardPage dashboard;
	private OrderEntry_Alais_PhoneOrderPage phoneorder;

	@Test(enabled=true,groups= {"Regression"}) 
	public void Validate_Hana_T326_OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_ExportToExcel_Functionality_Test() {
		// SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
		CustomSoftAssert softassert = new CustomSoftAssert();
		
		logger.info("**** Starting Hana_T326_OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_ExportToExcel_FT  ****");
		...
		try {
			...
			// Test Step - 10
			ThreadWait(5000);
			softassert.assertTrue(phoneorder.Verify_ExportToExcel_OnPaymentDetailsTab(),"Test Step - 10 - Export to excel button is not displayed on payment details tab at customer phone order page");
