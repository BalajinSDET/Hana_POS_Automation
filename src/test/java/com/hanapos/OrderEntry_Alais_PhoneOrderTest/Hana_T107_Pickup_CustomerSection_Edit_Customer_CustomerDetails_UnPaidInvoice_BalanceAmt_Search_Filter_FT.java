...
public class Hana_T107_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_BalanceAmt_Search_Filter_FT extends TestBaseClass {
	...
	public void Validate_Hana_T107_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_BalanceAmt_Search_Filter_Test() {
		SoftAssert softassert = new SoftAssert();
		logger.info("**** Starting Hana_T107_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_BalanceAmt_Search_Filter_FT  ****");
		...
		try {
			...
			// Test Step - 14
			delayWithGivenTime(1000);
			phoneorder.Enter_BalanceAmount_OnInvoiceSearchBox_UnpaidInvoiceTab("123456");
			delayWithGivenTime(1000);
			phoneorder.PressEnterKey();
			delayWithGivenTime(1000);
