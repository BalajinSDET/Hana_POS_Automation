...
public class Hana_T226_OrderEntryPage_Pickup_Payment_Section_WriteOff_Functionality extends TestBaseClass {
	...
	public void Validate_Hana_T226_OrderEntryPage_Pickup_Payment_Section_WriteOff_Functionality_Test(
		...
		logger.info("**** Starting  Validate_Hana_T226_OrderEntryPage_Pickup_Payment_Section_WriteOff_Functionality_Test  ****");
		...
		try {
			...
			// Test Step - 10			
			phoneorder.SelectPaymentTypeOnPhoneOrderPage_PaymentSection("Write Off");
			delayWithGivenTime(1000);
			softassert.assertEquals(phoneorder.get_SelectedPaymentType_OnPhoneOrderPage(),"Write Off", "Test Step - 10 - Selected payment type is not displayed");
			...
			// Test Step - 13
			softassert.assertEquals(orderconfirmationpage.get_PaymentType(), "Write Off", "Test Step - 13 - Payment type is not displayed on order confirmation page");
			...
			// Test Step - 15
			dashboardorder.EnterGlobalSearch(dashboardorder.get_InvoiceNumber_PhoneOrder_PickUp_WriteOff_PaymentType());
			delayWithGivenTime(1000);
			softassert.assertTrue(dashboardorder.Validate_PhoneOrder_WriteOff_PaymentType_PickUp_InvoiceNumber(),"Test Step - 15 - In orders summary page Write Off payment type invoice number is not displayed for placed order");		
		
			//Test Step - 16
			delayWithGivenTime(1000);
			softassert.assertEquals(dashboardorder.Validate_PhoneOrder_WriteOff_PaymentType_PickUp_ModeOfPayment(),"Write Off","Test Step - 16 - Mode of payment as Write Off type is not displayed");
