...
public class Hana_T152_Pickup_RecipientSection_AddressLookup_FT extends TestBaseClass {
	...
	public void Validate_Hana_T152_Pickup_RecipientSection_AddressLookup_FT_Functionality_Test() {
		...
		try {
			...
			// Test Step - 10
			delayWithGivenTime(1000);
			phoneorder.EnterReciAddress1("112 Penny Ct,");
			phoneorder.SearchAndSelectReciAddress1("112 Penny Ct, Ocean Springs, MS");
			delayWithGivenTime(2000);
			softassert.assertEquals(phoneorder.getReciAddress1(),"112 Penny Ct","Test Step - 10 - Recipient address 1 is not matched with customer address 1 field on phone order page recipient section");
			softassert.assertEquals(phoneorder.getReciZipcode(),"39564","Test Step - 10 - Recipient address 2 is not matched with customer address 2 on phone order page recipient section");
			softassert.assertEquals(phoneorder.getReciCity(),"Ocean Springs","Test Step - 10 - Recipient city is not matched with customer city on phone order page recipient section");
			softassert.assertEquals(phoneorder.getRecipientState(),"MS","Test Step - 10 - Recipient phone number is not matched with customer phonenumber 1 field on phone order page recipient section");
