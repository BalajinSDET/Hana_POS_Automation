...
public class Hana_T212__OrderEntryPage_Pickup_Payment_Section_Cash_Functionality extends TestBaseClass {
	...
	public void Validate_Hana_T212_OrderEntryPage_Pickup_Payment_Section_Cash_Functionality_Test(
		...
		logger.info("**** Starting  Validate_Hana_T212_OrderEntryPage_Pickup_Payment_Section_Cash_Functionality_Test  ****");
		...
		try {
			...
			// Test Step - 11
			delayWithGivenTime(1000); // Entered more than pay amount
			...
			// Test Step - 16
			softassert.assertEquals(orderconfirmationpage.get_PaymentType(), "Cash", "Test Step - 16 - Payment type is not displayed on order confirmation page");
			...
			// Test Step - 18
			dashboardorder.EnterGlobalSearch(dashboardorder.get_InvoiceNumber_PhoneOrder_PickUp_Cash_PaymentType());
			delayWithGivenTime(1000);
			softassert.assertTrue(dashboardorder.Validate_PhoneOrder_CashPaymentType_PickUp_InvoiceNumber(),"Test Step - 15 - In orders summary page cash payment type invoice number is not displayed for placed order");		
		
			//Test Step - 19
			delayWithGivenTime(1000);
			softassert.assertEquals(dashboardorder.Validate_PhoneOrder_CashPaymentType_PickUp_ModeOfPayment(),"Cash","Test Step - 19 - Mode of payment as cash type is not displayed");
