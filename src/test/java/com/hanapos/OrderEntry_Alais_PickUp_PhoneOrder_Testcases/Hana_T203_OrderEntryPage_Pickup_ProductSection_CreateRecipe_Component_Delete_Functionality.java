...
public class Hana_T203_OrderEntryPage_Pickup_ProductSection_CreateRecipe_Component_Delete_Functionality extends TestBaseClass {
	...
	public void Validate_Hana_T203_OrderEntryPage_Pickup_ProductSection_CreateRecipe_Component_Delete_Functionality_Test() {
		...
		try {
			...
			// Test Step - 18
			delayWithGivenTime(1000);
			softassert.assertTrue(phoneorder.Verify_DeleteIcon3_isDisplayed(),"Test Step - 18 - Delete icon is not displayed on added item table in create recipe popup");

			// Test Step - 19
			delayWithGivenTime(1000);
			softassert.assertEquals(phoneorder.Verify_Tooltip_OnDeleteIcon_IsDisplayed(),"Delete", "Test Step - 19 - Tooltip on delete icon is not displayed");
			
			// Test Step - 20
			phoneorder.Click_DeleteIcon3_OnCreateRecipePopup();
			delayWithGivenTime(2000);
			softassert.assertTrue(phoneorder.Verify_Row3_ProductIsDelete(),"Test Step - 20 - Recipe item row 3 is not deleted on added item gallery table");
