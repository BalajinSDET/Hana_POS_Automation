...
public class Hana_T300_OrderEntry_Delivery_CustomerSection_AltPhoneNumberField_Lookup_Functionality extends TestBaseClass {
...
public static final String dataSheetName = "Hana_T95";	
	...
	public void Validate_Hana_T300_OrderEntry_Delivery_CustomerSection_AltPhoneNumberField_Lookup_Functionality_Test(String salesperson, String custphone, String searchandselectaltphone) {
		// SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
		CustomSoftAssert softassert = new CustomSoftAssert();
		
		logger.info("**** Starting  Validate_Hana_T300_OrderEntry_Delivery_CustomerSection_AltPhoneNumberField_Lookup_Functionality_Test  ****");
