...
public class Hana_T330__OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_MOPSearchFilter_FT extends TestBaseClass {
	...
	public void Validate_Hana_T330_OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_MOPSearchFilter_Functionality_Test(String validMOP, String three_digit_MOP, String invalid_MOP) {
		// SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
		CustomSoftAssert softassert = new CustomSoftAssert();
		
		logger.info("**** Starting Hana_T330_OrderEntryPage_Delivery_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_MOPSearchFilter_FT  ****");
