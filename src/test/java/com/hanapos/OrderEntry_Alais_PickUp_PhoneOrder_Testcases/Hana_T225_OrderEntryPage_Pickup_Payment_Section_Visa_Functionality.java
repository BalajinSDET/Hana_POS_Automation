...
public class Hana_T225_OrderEntryPage_Pickup_Payment_Section_Visa_Functionality extends TestBaseClass {
	...
	public void Validate_Hana_T225_OrderEntryPage_Pickup_Payment_Section_Visa_Functionality_Test(
		...
		logger.info("**** Starting  Validate_Hana_T225_OrderEntryPage_Pickup_Payment_Section_Visa_Functionality_Test  ****");
		...
		try {
			...
			// Test Step - 10			
			phoneorder.SelectPaymentTypeOnPhoneOrderPage_PaymentSection("Visa");
			delayWithGivenTime(1000);
			softassert.assertEquals(phoneorder.get_SelectedPaymentType_OnPhoneOrderPage(),"Visa", "Test Step - 10 - Selected payment type is not displayed");
			...
			// Test Step - 13
			softassert.assertEquals(orderconfirmationpage.get_PaymentType(), "Visa", "Test Step - 13 - Payment type is not displayed on order confirmation page");
			...
			// Test Step - 15
			dashboardorder.EnterGlobalSearch(dashboardorder.get_InvoiceNumber_PhoneOrder_PickUp_Visa_PaymentType());
			delayWithGivenTime(1000);
			softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Visa_PaymentType_PickUp_InvoiceNumber(),"Test Step - 15 - In orders summary page Visa payment type invoice number is not displayed for placed order");		
		
			//Test Step - 16
			delayWithGivenTime(1000);
			softassert.assertEquals(dashboardorder.Validate_PhoneOrder_Visa_PaymentType_PickUp_ModeOfPayment(),"Visa","Test Step - 16 - Mode of payment as Visa type is not displayed");
