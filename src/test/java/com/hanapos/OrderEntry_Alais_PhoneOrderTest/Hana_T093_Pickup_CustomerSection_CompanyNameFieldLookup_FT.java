...
public class Hana_T093_Pickup_CustomerSection_CompanyNameFieldLookup_FT extends TestBaseClass {
	...
	public void Validate_Hana_T093_Pickup_CustomerSection_CompanyNameFieldLookup_Test() {
		SoftAssert softassert = new SoftAssert();
		logger.info("**** Starting  Hana_T95_Pickup_CustomerSection_CompanyNameFieldLookup_FT  ****");
		...
		try {
			...
			phoneorder.EnterCustomerCompanyName("Hana_Sisterchicks");
			...
			// Test Step - 8
			phoneorder.SearchAndSelect_CompanynameOnCustSection("Hana","Hana_Sisterchicks");
			delayWithGivenTime(2000);
