...
public class Hana_T238_OrderEntryPage_Pickup_Payment_Section_Donation_Functionality extends TestBaseClass {
	...
	public void Validate_Hana_T238_OrderEntryPage_Pickup_Payment_Section_Donation_Functionality_Test(
		...
		logger.info("**** Starting  Validate_Hana_T238_OrderEntryPage_Pickup_Payment_Section_Donation_Functionality_Test  ****");
		...
		try {
			...
			// Test Step - 10			
			phoneorder.SelectPaymentTypeOnPhoneOrderPage_PaymentSection("Donation");
			delayWithGivenTime(1000);
			softassert.assertEquals(phoneorder.get_SelectedPaymentType_OnPhoneOrderPage(),"Donation", "Test Step - 10 - Selected payment type is not displayed");
		
			// Test Step - 11			
			phoneorder.Enter_EINNumber_Textbox_On_PaymentSection("222888333777");	
			softassert.assertEquals(phoneorder.get_EINNumber_Textbox_On_PaymentSection(),"222888333777","Test Step - 11 - EIN number is not displayed on phone order page payment section");	
			...
			// Test Step - 14
			softassert.assertEquals(orderconfirmationpage.get_PaymentType(), "Donation", "Test Step - 14 - Payment type is not displayed on order confirmation page");
			...
			softassert.assertEquals(dashboardorder.validateDashboardOrderPage(),prop.getProperty("livedashboardorderURL"),"Test Step - 15 - Dashboard order page is not displayed");				
			
			// Test Step - 16
			dashboardorder.EnterGlobalSearch(dashboardorder.get_InvoiceNumber_PhoneOrder_PickUp_Donation_PaymentType());
			delayWithGivenTime(1000);
			softassert.assertTrue(dashboardorder.Validate_PhoneOrder_Donation_PaymentType_PickUp_InvoiceNumber(),"Test Step - 16 - In orders summary page Donation payment type invoice number is not displayed for placed order");		
			delayWithGivenTime(1000);
			softassert.assertEquals(dashboardorder.Validate_PhoneOrder_Donation_PaymentType_PickUp_ModeOfPayment(),"Donation","Test Step - 16 - Mode of payment as Donation type is not displayed");
