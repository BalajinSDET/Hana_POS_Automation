...
public class Hana_T156_OrderEntryPage_Pickup_RecipientSection_ZoneBasedDeliveryFee_FT extends TestBaseClass {
	...
	public void Validate_Hana_T156_OrderEntryPage_Pickup_RecipientSection_ZoneBasedDeliveryFee_Functionality_Test() {
		SoftAssert softassert = new SoftAssert();
		logger.info("**** Starting  Validate_Hana_T156_OrderEntryPage_Pickup_RecipientSection_ZoneBasedDeliveryFee_Functionality_Test ****");
		...
		try {
			...
			// Test Step - 11
			softassert.assertEquals(phoneorder.getDeliveryFees_PaymentSection_OnPhoneOrder(), "0.00","Test Step - 11 - Delivery fees is displayed on payment section in phone order page");
