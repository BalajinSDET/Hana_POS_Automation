...
public class Hana_T092_Pickup_CustomerSection_LastNameFieldLookup_FT extends TestBaseClass {
	...
	public void Validate_Hana_T092_Pickup_CustomerSection_LastNameFieldLookup_Test() {
		...
		try {
			...
			phoneorder.EnterCustomerLastName("Jones");
			...
			// Test Step - 8
			phoneorder.SearchAndSelect_LastnameOnCustSection("David","Abish David");
			delayWithGivenTime(2000);
