...
public class Hana_T094_Pickup_CustomerSection_PhoneNumberFieldLookup_FT extends TestBaseClass {
	...
	public void Validate_Hana_T094_Pickup_CustomerSection_PhoneNumberFieldLookup_Test() {
		...
		try {
			...
			phoneorder.EnterPhoneNumber("9566550756");
			...
			// Test Step - 8
			phoneorder.SearchAndSelect_phonenumberOnCustSection("9566550756","13827052 Abish David Hana_Sisterchicks (956-655-0756,956-655-0756)");
			delayWithGivenTime(2000);
