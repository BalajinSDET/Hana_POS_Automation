...
public class Hana_T247_OrderEntryPage_Pickup_Payment_Section_CreditCard_Use_ExistingCard_Functionality extends TestBaseClass {
	...
	public void Validate_Hana_T247_OrderEntryPage_Pickup_Payment_Section_CreditCard_Use_ExistingCard_Functionality_Test(
		...
		logger.info("**** Starting  Validate_Hana_T247_OrderEntryPage_Pickup_Payment_Section_CreditCard_Use_ExistingCard_Functionality_Test  ****");
		...
		try {
			...
			// Test Step - 11	
			phoneorder.Select_CreditcardType_CCPaymentSection_On_PhoneOrderPage("Use existing card");
			softassert.assertEquals(phoneorder.get_selected_CreditcardType_CCPaymentSection_On_PhoneOrderPage(), "Use existing card","Test Step - 11 - Use existing card dropdown option is not displayed as per expected on credit card payment type section");
			
			// Test Step - 12
		//	phoneorder.Click_Dont_Save_Checkbox_CCPaymentSection_On_PhoneOrderPage();
			delayWithGivenTime(1000);
			softassert.assertFalse(phoneorder.Verify_DontSave_Checkbox_CCPaymentSection_On_PhoneOrderPage_IsChecked(),"Test Step - 12 - Dont save checkbox is not checked as per expected");			
			...
			// Test Step - 29
			dashboardorder.EnterGlobalSearch(invoicenumber);//dashboardorder.get_InvoiceNumber_PhoneOrder_PickUp_CC_PaymentType()
			delayWithGivenTime(1000);
