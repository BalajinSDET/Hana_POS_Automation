...
public class Hana_T115_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Sorting_FT extends TestBaseClass {
	...
	public void Validate_Hana_T115_OrderEntryPage_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Sorting_Test() {
		// SoftAssert softassert = new SoftAssert(); - I have modified this to use CustomSoftAssert
		CustomSoftAssert softassert = new CustomSoftAssert();
		
		logger.info("**** Starting Hana_T115_OrderEntryPage_Pickup_CustomerSection_Edit_Customer_CustomerDetails_UnPaidInvoice_Sorting_FT  ****");
