...
public class Hana_T122_Pickup_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_Pay_Date_Search_Filter_FT extends TestBaseClass {
	...
	public void Validate_Hana_T122_Pickup_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_Pay_Date_Search_Filter_Functionality_Test() {
		...
		test.log(Status.INFO, "**** Starting Hana_T122_Pickup_OrderEntryPage_CustomerSection_Edit_Customer_CustomerDetails_PaymentDetails_Pay_Date_Search_Filter_Functionality  ****");
		...
		try {
			...
			test.log(Status.PASS, "User clicked on pickup type on phone order page");
			delayWithGivenTime(2000);
			...
			test.log(Status.PASS, "Test Step - 5 - User clicked on pickup type on phone order page successfully");
			...
			phoneorder = new OrderEntry_Alais_PhoneOrderPage();
			phoneorder.ClickPickupTypeOnPhoneOrderPage();
			test.log(Status.PASS, "User clicked on pickup type on phone order page successfully");
			delayWithGivenTime(2000);
			softassert.assertEquals(phoneorder.getHighlightedColorOnPickupTypeOnPhoneOrderPage(),"#2f9bc8", "Test Step - 5 - Pickup type is not highlighted in blue color");		
			test.log(Status.PASS, "Test Step - 5 - User verified pickup type is highlighted in blue color successfully");
			...
			test.log(Status.INFO, "**** Starting Hana T122 Pickup Order Entry Page Customer Section Edit Customer Customer Details Payment Details Pay Date Search Filter Functionality Test ****");
